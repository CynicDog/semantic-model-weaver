"""
Korea Telecom Subscriptions · Cortex Analyst Chat
--------------------------------------------------
A minimal Streamlit chat app that talks to the Snowflake Cortex Analyst REST API
using the 아정당 telecom contracts, marketing, and call-center insights semantic model.
...
st.set_page_config(
    page_title="Korea Telecom · Cortex Analyst",
    page_icon="📡",
    layout="wide",
)
st.markdown("""
