...
def _render_results(df) -> None:
    """Show results as a table and, when the shape allows, an auto chart."""
...
st.set_page_config(
    page_title="Nextrade · Cortex Analyst",
    page_icon="📈",
    layout="wide",
)
st.markdown("""
